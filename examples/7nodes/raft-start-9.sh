...
if [ "$privacyImpl" == "tessera" ]; then
  ...
  ./tessera-start-node9only.sh ${tesseraOptions}
...
#PRIVATE_CONFIG=qdata/c9/tm.ipc nohup geth --etherbase 0x9876543210000000000000000000000000000000 --datadir qdata/dd9 $ARGS --raftport 50409 --rpcport 22008 --port 21008 --unlock 0 --password passwords.txt -raftjoinexisting $nodeId 2>>qdata/logs/9.log &
set +v
