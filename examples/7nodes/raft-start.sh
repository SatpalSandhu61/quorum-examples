...
elif [ "$privacyImpl" == "none" ]; then
  echo "[*] Running without Transaction Manager"
else
...
set -v
ARGS="--nodiscover --verbosity 3 --networkid $NETWORK_ID --raft --rpc --rpcaddr 0.0.0.0 --rpcapi admin,db,eth,debug,miner,net,shh,txpool,personal,web3,quorum,raft --emitcheckpoints $QUORUM_GETH_ARGS "
