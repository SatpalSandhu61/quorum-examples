...
if [ "$privacyImpl" == "tessera" ]; then
  ...
  ./tessera-start-node8only.sh ${tesseraOptions}
...
#PRIVATE_CONFIG=qdata/c8/tm.ipc nohup geth --etherbase 0x9876543210000000000000000000000000000000 --datadir qdata/dd8 $ARGS --raftport 50408 --rpcport 22007 --port 21007 --unlock 0 --password passwords.txt -raftjoinexisting $nodeId 2>>qdata/logs/8.log &
set +v
